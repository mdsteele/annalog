...
.PROC DataA_Console_DiagramBank_u8_arr
    ...
    d_byte MultiplexerPlatform, kChrBankDiagramMultiplexerPlatform
    d_byte MultiplexerValve,    kChrBankDiagramMultiplexerValve
...
.PROC DataA_Console_DiagramFirstTileId_u8_arr
    ...
    d_byte MultiplexerPlatform, kTileIdBgDiagramMultiplexerPlatformFirst
    d_byte MultiplexerValve,    kTileIdBgDiagramMultiplexerValveFirst
