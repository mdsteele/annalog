...
.IMPORT DataA_Terrain_BuildingLowerLeft_u8_arr
.IMPORT DataA_Terrain_BuildingLowerRight_u8_arr
.IMPORT DataA_Terrain_BuildingUpperLeft_u8_arr
.IMPORT DataA_Terrain_BuildingUpperRight_u8_arr
...
.IMPORT DataA_Terrain_ShadowLowerLeft_u8_arr
.IMPORT DataA_Terrain_ShadowLowerRight_u8_arr
.IMPORT DataA_Terrain_ShadowUpperLeft_u8_arr
.IMPORT DataA_Terrain_ShadowUpperRight_u8_arr
...
.EXPORT DataA_Room_Building_sTileset
.PROC DataA_Room_Building_sTileset
    D_STRUCT sTileset
    d_addr UpperLeft_u8_arr_ptr,  DataA_Terrain_BuildingUpperLeft_u8_arr
    d_addr LowerLeft_u8_arr_ptr,  DataA_Terrain_BuildingLowerLeft_u8_arr
...
.EXPORT DataA_Room_Shadow_sTileset
.PROC DataA_Room_Shadow_sTileset
    D_STRUCT sTileset
    d_addr UpperLeft_u8_arr_ptr,  DataA_Terrain_ShadowUpperLeft_u8_arr
    d_addr LowerLeft_u8_arr_ptr,  DataA_Terrain_ShadowLowerLeft_u8_arr
