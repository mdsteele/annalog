...
;;; The machine index for the LavaTunnelBoiler machine in this room.
kBoilerMachineIndex = 0

;;; Platform indices for various parts of the LavaTunnelBoiler machine.
...
:   .assert * - :- = kBoilerMachineIndex * .sizeof(sMachine), error
    D_STRUCT sMachine
    d_byte Code_eProgram, eProgram::LavaTunnelBoiler
    ...
    d_addr ReadReg_func_ptr, FuncC_Lava_TunnelBoiler_ReadReg
    d_addr WriteReg_func_ptr, FuncA_Machine_LavaTunnelBoiler_WriteReg
...
.PROC FuncC_Lava_TunnelBoiler_ReadReg
    cmp #$c
    beq _ReadL
...
.PROC FuncA_Machine_LavaTunnelBoiler_WriteReg
    cpx #$c
    beq _WriteL
...
;;; TryAct implemention for the LavaTunnelBoiler machine.
