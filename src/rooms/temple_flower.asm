...
.PROC DataC_Temple_Flower_sRoom
    ...
    d_addr Tick_func_ptr, FuncC_Temple_Flower_TickRoom
...
_Ext_sRoomExt:
    ...
    d_addr Enter_func_ptr, FuncC_Temple_Flower_EnterRoom
...
:   .assert * - :- = kFlowerDeviceIndex * .sizeof(sDevice), error
    ...
    d_byte Target_u8, eFlag::FlowerTemple
    D_END
...
.PROC FuncC_Temple_Flower_EnterRoom
