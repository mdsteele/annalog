...
:   .assert * - :- = kMultiplexerMachineIndex * .sizeof(sMachine), error
    ...
    d_addr Init_func_ptr, FuncC_Sewer_WestMultiplexer_Init
    ...
    d_addr Reset_func_ptr, FuncC_Sewer_WestMultiplexer_Reset
    D_END
...
:   .repeat kMultiplexerNumPlatforms, index
    ...
    d_word Left_i16, kMultiplexerMinPlatformLeft
...
.PROC FuncC_Sewer_WestMultiplexer_Init
    .assert * = FuncC_Sewer_WestMultiplexer_Reset, error, "fallthrough"
.ENDPROC

.PROC FuncC_Sewer_WestMultiplexer_Reset
    lda #0
...
_MainPlatform:
    ...
    lda #kPaletteObjMachineLight  ; param: objects flags
