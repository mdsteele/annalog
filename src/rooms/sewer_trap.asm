...
_Ext_sRoomExt:
    ...
    D_END
_TerrainData:
:   .incbin "out/data/sewer_trap.room"
    .assert * - :- = 18 * 24, error
...
:   .assert * - :- = kLiftMachineIndex * .sizeof(sMachine), error
    ...
    d_addr Init_func_ptr, FuncA_Room_SewerTrapLift_InitReset
    ...
    d_addr Reset_func_ptr, FuncA_Room_SewerTrapLift_InitReset
    D_END
...
.PROC FuncA_Room_SewerTrapLift_InitReset
    lda #kLiftInitGoalY
