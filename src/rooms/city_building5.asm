...
.IMPORT DataC_City_Building5TerrainData
...
.EXPORT DataC_City_Building5_sRoom
.PROC DataC_City_Building5_sRoom
    D_STRUCT sRoom
    ...
    d_addr TerrainData_ptr, DataC_City_Building5TerrainData
...
:   D_STRUCT sDevice
    ...
    d_byte Target_byte, eFlag::PaperJerome30
    D_END
    D_STRUCT sDevice
